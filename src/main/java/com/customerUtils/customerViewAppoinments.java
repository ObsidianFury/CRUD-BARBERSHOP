 ...
 * @author Mixalhs
 */
public class customerViewAppoinments extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(customerViewAppoinments.class.getName());

    /**
     * Creates new form customerLandingPage
     */
    public customerViewAppoinments() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Customer View Appoinments");
        ...
        jLabel7.setText("My appoinments:");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new customerViewAppoinments().setVisible(true));
    }
